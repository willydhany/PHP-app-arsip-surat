...
if (isset($_POST['btnEdit'])) {
	...
	mysql_query("UPDATE mail SET incoming_at='$incoming_at',mail_code='$mail_code',mail_date='$mail_date',mail_from='$mail_from',mail_to='$mail_to',mail_subject='$mail_subject',description='$description',id_mail_type='$id_mail_type' WHERE id_mail='$id_mail'");
	echo "<meta http-equiv='refresh' content='0; url=?page=Surat-Masuk-Data&pesan=update'>";
}
?> 
	...
	?>
	    <div class="form-group">
	      ...
	      <div class="col-sm-9">
	        <input type="text" class="form-control" name="id_mail" id="id_mail" value="<?php echo $data['id_mail']; ?>" readonly>
	      </div>
	    </div>
	    <div class="form-group">
	      ...
	      <div class="col-sm-9">          
	        <div class="input-group date form_date col-sm-4" data-date="" data-date-format="yyyy-mm-dd" data-link-field="dtp_input1" data-link-format="yyyy-mm-dd">
	                    <input class="form-control" type="text" value="<?php echo $data['incoming_at']; ?>" name="incoming_at">
	    ...
	    <div class="form-group">
	      ...
	      <div class="col-sm-9">          
	        <input type="text" class="form-control" name="mail_from" id="mail_from" value="<?php echo $data['mail_from']; ?>">
	      </div>
	    </div>
	    <div class="form-group">
	    ...
	    <div class="form-group">
	      ...
	      <div class="col-sm-9">          
	        <input type="text" class="form-control" name="file_upload" id="file_upload" value="<?php echo $data['file_upload']; ?>" readonly>
	      </div>
	    </div>
	    <div class="form-group">
